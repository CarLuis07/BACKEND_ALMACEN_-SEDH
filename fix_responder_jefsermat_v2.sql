...
-- El problema: Las RAISE EXCEPTION no se propagan correctamente en algunos casos
...
BEGIN
    ...
    IF EXISTS (
        ...
        RETURN 'ERROR: Esta requisición ya fue respondida por Jefe de Materiales';
    END IF;
    ...
    -- Insertar registro de aprobación - ESTA ES LA LÍNEA CRÍTICA
